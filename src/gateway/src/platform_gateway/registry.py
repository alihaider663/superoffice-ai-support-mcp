...
def create_default_routing_table() -> GatewayRoutingTable:
    ...
    canonical_routes: list[ToolRouteDefinition] = [
        ...
        ToolRouteDefinition(
            tool_name="sync_codebase",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
        ToolRouteDefinition(
            tool_name="list_extra_tables",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
        ToolRouteDefinition(
            tool_name="get_extra_table_schema",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
        ToolRouteDefinition(
            tool_name="query_extra_table",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
        ToolRouteDefinition(
            tool_name="get_ticket_audit_trail",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
        ToolRouteDefinition(
        ...
        ToolRouteDefinition(
            tool_name="get_associate_details",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
        ToolRouteDefinition(
            tool_name="get_ticket_metadata_lists",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
        ToolRouteDefinition(
            tool_name="list_system_events_and_triggers",
            target_server=TargetServer.SUPEROFFICE,
            endpoint_path="/mcp",
        ),
